        ...
        ?>
         ...
         <main class="page-content">
            <div class="container">
                ...
                <form method="POST" action="../../controller/tecnico_controller/cont_add_cartVacinacao.php" enctype="multipart/form-data" class="alert alert-secondary">
                    <div class="container">
                        ...
                        <div class="row  py-3 mb-5">
                            ...
                            <?php
                               $carteinha_vac = $dados_tecuser['carteirinha_vacinacao'];
